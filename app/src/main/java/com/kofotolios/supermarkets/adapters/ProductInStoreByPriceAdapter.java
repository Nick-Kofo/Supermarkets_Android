 ...
 */
public class ProductInStoreByPriceAdapter extends BaseAdapter {
    Context c;
    ArrayList<Product> products;
    public static ArrayList<Product> cartProductsByPrice = new ArrayList<>();

    public ProductInStoreByPriceAdapter(Context c, ArrayList<Product> products) {
        this.c = c;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null)
        {
            view = LayoutInflater.from(c).inflate(R.layout.productinstorebyprice, viewGroup, false);
        }
        ...
        fabCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //add product to cart
                Product product = (Product) ProductInStoreByPriceAdapter.this.getItem(i);
                cartProductsByPrice.add(product);
